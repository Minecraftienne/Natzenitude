...
public class Entretien : MonoBehaviour {
	...
	void OnGUI() {
		...
		GUI.Button(new Rect(250, 190, 110, 30), "Arrosage");
		GUI.Button(new Rect(250, 230, 110, 30), "Réglages");
		GUI.Button(new Rect(250, 270, 110, 30), "Taille");
